...
<template>
  <div class="hero grid  grid-cols-2 place-items-center md:py-32 h-screen">
    ...
    >
      <NuxtLink
        to="quote"
        class="hero-quote bg-blue-400 md:mr-4 hover:bg-blue-300 hover:text-black p-2 rounded-md duration-150"
        >Get A Free Quote</NuxtLink
      >
      <NuxtLink
        to="#services"
        class="hero-quote p-2 border-2 border-gray-400 rounded-md hover:bg-yellow-300 text-black hover:border-yellow-300 duration-150"
