...
<template>
  <div>
    <div class="py-32 grid place-items-center bg-white dark:bg-black dark:text-white">
      <div class="quote-container p-4 md:p-16 border-2 rounded-lg">
        <form class="booking-form flex flex-col self-center space-y-6">
          ...
          <div class="form-group">
            ...
            <input type="text" id="name" v-model="customerName" class="dark:bg-gray-800 dark:text-white rounded-lg p-1"
              required placeholder="Your Name" />
          </div>
          <div class="form-group">
            <label for="email">Email:</label>
            <input type="text" id="email" v-model="customerEmail"
              class="dark:bg-gray-800 dark:text-white rounded-lg p-1" required placeholder="Your Email" />
          </div>

          <div class="form-group">
            <label for="solar-panel-count" class="text-xl">Number of Solar Panels:</label>
            <input type="number" id="solar-panel-count" v-model="solarPanelCount"
              class="dark:bg-gray-800 dark:text-white rounded-lg p-1" />
          </div>
          <div class="form-group">
            <label for="booking-date">Booking Date:</label>
            <input type="date" id="booking-date" v-model="bookingDate"
              class="dark:bg-gray-800 dark:text-white rounded-lg p-1" required />
          </div>
